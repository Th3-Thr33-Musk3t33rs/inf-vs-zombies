...
const CharacterInfo CHARACTER_INFO[] = {
    ...
    [CHAR_TYPE_TRALALERO] = {CHAR_TYPE_TRALALERO, TRALALERO_COST, TRALALERO_CD, TRALALERO_INITIAL_HP, TRALALERO_TEXTURE, (Rectangle){13, 57, 186, 144}, (Vector2){186 / 2.0f, 144 / 2.0f}, {0, 0}},
    [CHAR_TYPE_SAHUR] = {CHAR_TYPE_SAHUR, SAHUR_COST, SAHUR_CD, SAHUR_COST, SAHUR_TEXTURE, (Rectangle){0, 0, 180, 264}, (Vector2){180 / 2.5f, 244 / 2.5f}, defaultOffset},
